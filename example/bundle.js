...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FauxFlux = __webpack_require__(1);
	var mobx = __webpack_require__(3);
	var _IncrementalDOM = IncrementalDOM,
	    patch = _IncrementalDOM.patch,
	    eO = _IncrementalDOM.elementOpen,
	    eC = _IncrementalDOM.elementClose,
	    eV = _IncrementalDOM.elementVoid,
	    tX = _IncrementalDOM.text,
	    attributes = _IncrementalDOM.attributes;
	...
	var FF = new FauxFlux(store, actions, { useStrict: true, debug: true });
	...
	var localStorageActions = [{
	  ...
	  action: function action(_ref13, key) {
	    ...
	    if (jsonTodos) {
	      mobx.set(store, { todos: JSON.parse(jsonTodos) });
	    }
	  }
	}, {
	  name: 'localStorage_set_todos',
	  action: function action(_ref14, _ref15) {
	...
	FF.dispatch('localStorage_init_todos', key).then(function () {
	  ...
	  FF.mobx.autorun(function () {
	    var todos = FF.mobx.toJS(store.todos);
	    FF.dispatch('localStorage_set_todos', { key: key, todos: todos });
	  });
	});
	...
	var MainView = FF.mobx.autorun(function () {
	  ...
	  patch(mainElement, function () {
	    ...
	    shownTodos.forEach(function (todo) {
	      ...
	      eC('div');
	      eV('input', null, null, 'type', 'input', 'value', todo.editingText, 'id', 'edit' + todo.id, 'class', 'edit', 'onblur', function (e) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global, process) {/** MobX - (c) Michel Weststrate 2015, 2016 - MIT Licensed */
	'use strict';
	...
	*/
	...
	exports.extendShallowObservable = extendShallowObservable$$1;
